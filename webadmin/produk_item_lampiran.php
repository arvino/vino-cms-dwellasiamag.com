...
include"menu_produk.php";?>
         ...
         <td width="78%"><div align="center">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr valign="top">
                 <td background="images/box/B2_Batas_Kiri.png" width="9"> </td>
                 <td background="images/box/B2_Latar.png"> <span class="JudulKanal_box1">PRODUK ITEM FILE LAMPIRAN</span>
                     <hr class='line_box'>
                     <?php
...
<?php
$iditem = $_GET['iditem'];
$row_item = Select_Detail_Item_produk($tbl_produk, $iditem);
if( !isset($action) ){
	$FormprodukItemLampiran_Action = "produk_proses_itemlampiran.php?action=itemlampiran_tambahdata";
	$produkkategori_submitbutton = "Tambah Lampiran...";
	$Tombol_CANCEL = "<input type='reset' name='reset' value='CANCEL' class='button' onClick=\"javascript:location.replace('produk_item_lampiran.php?iditem=$iditem')\" >";
}


if( $action == "EditData" ){
	$id = $_GET['id'];
	$FormprodukItemLampiran_Action = "produk_proses_itemlampiran.php?action=itemlampiran_updatedata";
	$produkkategori_submitbutton = "Update Lampiran...";
	$Tombol_CANCEL = "<input type='reset' name='reset' value='CANCEL' class='button' onClick=\"javascript:location.replace('produk_item_lampiran.php?iditem=$iditem')\" >";
...
<?php
include"menu_produk2.php";?>
                     <br>
<?php
include"produk_preview_item.php";?>
                     <br>
<?php
include"produk_list_itemlampiran.php";?>
                     <br>
<?php
include"produk_form_itemlampiran.php";?>
<?php
} ?>                 
