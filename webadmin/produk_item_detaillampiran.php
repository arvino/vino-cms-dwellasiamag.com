...
$produkFileHit = produkfileDiLihat( $tbl_produkfile, $id );
 

$_SESSION['filelampiran_$id_produklog'] = $id_produklog;
$_SESSION['id_produklog'] = $id_produklog;
...
<ul class="link_action">
	<li class="link_action"> <a href="javascript:location.reload(true)" class="link_action"> Refresh halaman  </a> </li>
	<li class="link_action"> <a href="produk_filelampiran.php" class="link_action"> Tutup Window </a> </li>
</ul> </span>
<?php
