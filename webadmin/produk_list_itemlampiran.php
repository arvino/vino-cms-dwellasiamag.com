...
<?php
$result_itemlampiran = ViewAll_produkItemLampiran_ByItem( $tbl_produkfile, $iditem );
$hitungdata = TotalAllDataprodukItemLampiran( $tbl_produkfile, $iditem );
?>
<?php
if($hitungdata == 0){
?>
...
$view_detail_lampiran_produk = "produk_item_detaillampiran.php?iditem=$row_filelampiran->idkonten&id=$row_filelampiran->id";
}
...
$scrollbar = "scrollbars=yes";
$LokasiFile = "../" . $row_filelampiran->direktorifile . $row_filelampiran->namafile;
//$view_detail_lampiran_produk = "$LokasiFile";
$view_detail_lampiran_produk = "produk_item_detaillampiran.php?iditem=$row_filelampiran->idkonten&id=$row_filelampiran->id";
}
...
echo $view_detail_lampiran_produk ?>','printWindowFileLampiran<?php
...
<a href='produk_item_lampiran.php?iditem=<?php
...
<br>
Hit :  <?php
echo $row_filelampiran->hitcounter ?> <br>
<br>
</div> 
