...
function JavaScript_Konfirmasi( id ){
	...
	if (answer)
	window.location="produk_proses_kanal.php?action=kanal_hapusdata&id=" + id 
	else
	window.location="produk_kanal.php"
}
</script> 
         ...
         <td width="78%"><div align="center">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr valign="top">
                 <td background="images/box/B2_Batas_Kiri.png" width="9"> </td>
                 <td background="images/box/B2_Latar.png"> 
				 <span class="JudulKanal_box1">produk | halaman  KATEGORI </span>
				 <hr class='line_box'>
                     <?php
...
<?php
if($action=="EditData"){                                                       
$FormprodukKategori_Action = "produk_proses_kanal.php?action=kanal_updatedata";
$produkkategori_submitbutton = "UPDATE DATA......";
$Tombol_CANCEL = "<input type='reset' name='reset' value='CANCEL' class='button' onClick=\"javascript:location.replace('produk_kanal.php')\" >";
...
if( !isset($action) ){
$FormprodukKategori_Action = "produk_proses_kanal.php?action=kanal_tambahdata";
$produkkategori_submitbutton = "ADD DATA...";
$Tombol_CANCEL = "<input type='reset' name='reset' value='CANCEL' class='button' onClick=\"javascript:location.replace('produk_kanal.php')\" >";
}
?>
                     <?php
include"produk_form_kanal.php"; ?>
                     <br>
                     <?php
include"produk_list_kanal.php"; ?>
                     <?php
} 
?>
                 </td>
