...
function Ambil_SubKategori(str1,str2){
	...
	xmlhttp.open("GET","peopledirectory_tampilsubkategori.php?idkategori="+str1+"&idkategorisub="+str2,true);
	xmlhttp.send();
}
...
<span class="JudulKanal_box1"> PAGE PORTFOLIO DIRECTORY MANAGER</span>
<hr class='line_box'>
...
/* Kata Pengantar epeopledirectory */
if(!isset($action)){
	$action = $_GET['action'];
	include"peopledirectory_pengantar.php";
