...
<tr class='kontenform'>
	<td colspan='3' class='kontenform'> NO. FILE EXTRA </td>
</tr>
...
$view_detail_lampiran_peopledirectory = "peopledirectory_item_detaillampiran.php?iditem=$row_filelampiran->idkonten&id=$row_filelampiran->id";
}
...
$scrollbar = "scrollbars=yes";
$LokasiFile = "../" . $row_filelampiran->direktorifile . $row_filelampiran->namafile;
//$view_detail_lampiran_peopledirectory = "$LokasiFile";
$view_detail_lampiran_peopledirectory = "peopledirectory_item_detaillampiran.php?iditem=$row_filelampiran->idkonten&id=$row_filelampiran->id";
}
...
echo $view_detail_lampiran_peopledirectory ?>','printWindowFileLampiran<?php
echo $row_filelampiran->idkonten ?>
	<?php
