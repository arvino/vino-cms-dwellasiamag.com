...
<textarea name="deskripsi" cols="98%" rows="100%" id="content" class="ckeditor"> <?php
...
<b> Related Wordtag Content :  </b><br>
...
echo $jam_selesai_tampil_item_news ?>" size="8" maxlength="6"> 
              ( HH:MM ) 
			   ...
			   <label> 
			    <input name="withoutend" type="checkbox" id="withoutend" value="1" <?php
echo $ck_withoutend ?>>
				WITHOUT END
				</label>
            ...
            <tr>
              <td>IMAGE THUMB FOR PREVIEW </td>
              <td><div align="center">:</div></td>
              <td><input name="file_thumb" type="file" id="file_thumb"></td>
            </tr>
            <tr>
              <td>IMAGE MEDIUM FOR HEADLINE </td>
              <td><div align="center">:</div></td>
              <td><input name="file_medium" type="file" id="file_medium"></td>
            </tr>
            <tr>
              <td>IMAGE BIG FOR DETAIL PAGE </td>
              <td><div align="center">:</div></td>
...
echo $row_item->gambarbesar ?>'> <br>
                  <br>
                  IMAGE BIG / FOR DETAIL PAGE <br>
                  <br>
				  <br>
				  ...
				  <img src='../<?php
echo $row_item->direktorigambar ?><?php
echo $row_item->gambarsedang ?>' width='400'> <br>
                  <br>
                  IMAGE MEDIUM / FOR HEADLINE SLIDE <br>
				  <br>
				  <br>
...
echo $row_item->gambarkecil ?>'>
				<input name='gambarsedang' type='hidden'  value='<?php
echo $row_item->gambarsedang ?>'>
