...
function JavaScript_Konfirmasi( idkategori, id ){
	...
	if (answer)
	window.location="peopledirectory_proses_subkanal.php?action=subkanal_hapusdata&id=" + id 
	else
	window.location="peopledirectory_subkanal.php?idkategori=" + idkategori
}
</script> 
</head>
...
?>
<span class="JudulKanal_box1">PEOPLE PORTFOLIO DIRECTORY | SUB SECTION halaman   </span>
<hr class='line_box'>
...
$r_peopledirectorykategori = mysql_fetch_array($r_datapeopledirectory_kategori);


if($idkategori==0){

$peopledirectorykategori_keterangan = "TANPA KATEGORI / KANAL ";
...
$FormpeopledirectoryKategoriSub_Action = "peopledirectory_proses_subkanal.php?action=subkanal_updatedata";
$peopledirectorysubkategori_submitbutton = "UPDATE DATA......";
$Tombol_CANCEL = "<input type='reset' name='reset' value='Cancel' class='button' onClick=\"javascript:location.replace('peopledirectory_subkanal.php?idkategori=$idkategori')\" >";
...
if( !isset($action) ){
$FormpeopledirectoryKategoriSub_Action = "peopledirectory_proses_subkanal.php?action=subkanal_tambahdata";
$peopledirectorysubkategori_submitbutton = "Add Data...";
$Tombol_CANCEL = "<input type='reset' name='reset' value='Cancel' class='button' onClick=\"javascript:location.replace('peopledirectory_subkanal.php?idkategori=$idkategori')\" >";
...
<?php
include"peopledirectory_form_subkanal.php";?>
<br>
<?php
include"peopledirectory_list_subkanal.php"; ?>
<br>
<?php
} ?></td>
                 <td background="images/box/B2_Batas_Kanan.png" width="8"> </td>
