...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	header("location:peopledirectory_kanal.php?pesan_error=FAILED ! ACCESS DENIED.");  
...
if( $keterangan =='' ){
	...
	header("location:peopledirectory_kanal.php?pesan_error=PLEASE FILL TITLE.");  
	
}else{

$id = peopledirectoryKategori_CreateID( $tbl_peopledirectorykategori ); 
$idupline = $idupline;
...
$sql_hitungdata = peopledirectoryKategori_Periksaketerangan( $tbl_peopledirectorykategori, $keterangan, $keteranganinggris );  
$hitung_data = mysql_num_rows($sql_hitungdata);
if( $hitung_data > 0 ){ 

	header("location:peopledirectory_kanal.php?pesan_error=FAILED ! TITLE EXIST"); 
...
if( $image_file_logo == "" ){ /* JIka tida ada upload file logo */
	...
	$loc_root = "../";	
	$loc_file = "filemodul/peopledirectory/file_kanal/";
...
/* Simpan data ke database */
	peopledirectoryKategori_TambahData( 
	...
	header("location:peopledirectory_kanal.php?pesan_error=SUCCESS ADD DATA !");  
}}}  
}
/* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- */
...
if( $keterangan=='' ){
	...
	header("location:peopledirectory_kanal.php?action=EditData&idkategori=" . $idkategori . "&pesan_error=PLEASE FILL THE TITLE"); 
...
if( $hitung_data > 1 ){  
	...
	header("location:peopledirectory_kanal.php?id=$id&action=EditData&pesan_error=FAILED ! TITLE ALREADY EXIST");  
...
/* Simpan data */
peopledirectoryKategori_UpdateData(
		$tbl_peopledirectorykategori,
		$id, $idupline, $keterangan, $keteranganinggris,
		$posisi, $urutan,
		$homehalamantampil, $menuatas1, $menuatas2,
		...
		$hit, $linkjudul, $keyword
	 	...
	 	header("location:peopledirectory_kanal.php?id=$id&action=EditData&pesan_error=UPDATE SUCCESSFULLY."); 
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	unlink($image_kanal);
	peopledirectoryKategori_update_image_logo( $tbl_peopledirectorykategori, $id );
	header("location:peopledirectory_kanal.php?action=EditData&id=$id&pesan_error=DELETE SUCCESSFULLY"); 
}
}
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	unlink($image_kanal);
	peopledirectoryKategori_update_image_header( $tbl_peopledirectorykategori, $id );
	header("location:peopledirectory_kanal.php?action=EditData&id=$id&pesan_error=SUCCESS DELETE DATA."); 
}
}
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	unlink($image_kanal);
	peopledirectoryKategori_update_image_background( $tbl_peopledirectorykategori, $id );
	header("location:peopledirectory_kanal.php?action=EditData&id=$id&pesan_error=SUCCESS DELETE IMAGE DATA"); 
}
}
/* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- */
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	header("location:peopledirectory_kanal.php?pesan_error=SUCCESS PUBLISH DATA."); 
}
}
/* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- */
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	$image_kanal = $root_image . $imagefile . $imagelogo;
	unlink($image_kanal);
	peopledirectoryKategori_hapusdata( $tbl_peopledirectorykategori, $id );
	header("location:peopledirectory_kanal.php?pesan_error=SUCCESS DELETE DATA."); 
} 
}	
/* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- */
