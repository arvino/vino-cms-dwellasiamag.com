...
if( $idkategori == 0 ){ 
$bannerkategori_id = 0;
$bannerkategori_keterangan = "<font color='red'> WITHOUT SECTION </font>";
}else{
...
if( $action=="EditData" ){ ?>
  <option value="<?php
echo $row_item->target ?>"> -- <?php
echo $row_item->target ?> -- </option>
<?php
} ?>
...
<?php
$FormatFileBanner = end(explode(".",  $row_item->namafile));
$tipefileBanner = strtolower($FormatFileBanner);
if($tipefileBanner=="swf" OR $tipefileBanner=="SWF"){
?>
 
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0"  width="600">
...
echo $link_host ?><?php
echo $row_item->direktorigambar ?><?php
echo $row_item->namafile ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="600"></embed>
</object>
...
?>
<a href="<?php
echo $row_item->linkurl  ?>" target="<?php
echo $row_item->target  ?>"> 
    <img src='<?php
echo $link_host ?><?php
echo $row_item->direktorigambar ?><?php
