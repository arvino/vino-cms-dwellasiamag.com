...
$peopledirectoryFileHit = peopledirectoryfileDiLihat( $tbl_peopledirectoryfile, $id );
 

$_SESSION['filelampiran_$id_peopledirectorylog'] = $id_peopledirectorylog;
$_SESSION['id_peopledirectorylog'] = $id_peopledirectorylog;
...
<ul class="link_action">
	<li class="link_action"> <a href="javascript:location.reload(true)" class="link_action"> Refresh halaman  </a> </li>
	<li class="link_action"> <a href="peopledirectory_filelampiran.php" class="link_action"> Tutup Window </a> </li>
</ul> </span>
<?php
