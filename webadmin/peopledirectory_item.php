...
function Ambil_SubKategori(str1,str2){
	...
	xmlhttp.open("GET","peopledirectory_tampilsubkategori.php?idkategori="+str1+"&idsubkategori="+str2,true);
	xmlhttp.send();
}
...
function JavaScript_Konfirmasi_Item( idkategori, idkategorisub, id ){
	...
	if (answer)
	window.location="peopledirectory_proses_item.php?action=item_hapusdata&idkategori=" + idkategori + "&idkategorisub=" + idkategorisub + "&id=" + id
	else
	window.location="peopledirectory_item.php?idkategori=" + idkategori + "&idsubkategori=" + idkategorisub + "&id=" + id + "&action=ViewList"
}
...
function JavaScript_Konfirmasi_ItemKomentar( id, iditem ){
	var answer = confirm ("Are you sure want to delete this file.")
	if (answer)
	window.location="peopledirectory_proses_itemkomentar.php?action=itemkomentar_hapusdata&iditem="+  iditem  +"&id=" + id 
	else
	window.location="peopledirectory_item_komentar.php?iditem=" + iditem
}
...
$idkategori = $_GET["idkategori"];
$idkategorisub = $_GET["idsubkategori"];
$detail_kanal = Select_Detail_Kategori_peopledirectory( $tbl_peopledirectorykategori, $idkategori );
$detail_subkanal = Select_Detail_KategoriSub_peopledirectory( $tbl_peopledirectorykategorisub, $idkategorisub )
...
<span class="JudulKanal_box1"> DIRECTORY PORTFOLIO halaman <?php
...
<?php
include"peopledirectory_menu_subkanal.php"; ?>
<?php
include"peopledirectory_menu_1.php";?>
...
/* Form Komentar */
	$FormpeopledirectoryItemKomentar_Action = "peopledirectory_proses_itemkomentar.php?action=itemkomentar_tambahdata";
	$peopledirectorykategori_submitbutton = "ADD COMMENT...";
	$Tombol_CANCEL = "<input type='reset' name='reset' value='CANCEL' class='button' onClick=\"javascript:location.replace('peopledirectory_item_komentar.php?iditem=$iditem')\" >";
		...
		echo "<br>";
		echo "<br>";
		include"peopledirectory_list_item.php";
		break;
		...
		<tr class='kontenform'>
		<td>";
		include"peopledirectory_detail_item.php";
		$iditem = $id;
		echo "<br>";
		...
		Case 'FormEntry': 
		include"peopledirectory_form_item.php";
		$iditem = $id;
		echo "
